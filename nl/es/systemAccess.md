...
**Nota:** el URL de **apiEndpoint** al que se hace referencia en los [ejemplos de las API REST](https://github.com/IBM-Cloud/WebSphere-in-Bluemix/tree/master/WebSphere-In-Bluemix-API-Examples){: new_window} apunta a la región del sur de Estados Unidos. Si utiliza otras regiones, asegúrese de que la aplicación hace referencia al **apiEndpoint** apropiado.
...
3. Conéctese a la red de VPN y, a continuación, podrá acceder a la máquina virtual. Después del primer acceso, Tunnelblick almacena en memoria caché la configuración y puede conectarse desde Tunnelblick. Puede colocar un icono en la barra de menús de la parte superior para un acceso más fácil.
...
* Los mandatos de WebSphere Application Server tradicional se pueden emitir desde la ubicación del perfil predeterminado en */opt/IBM/WebSphere/Profiles/Default**profile_typeprofile_number**/bin* donde:
  * **profile_type** es un valor de *AppSrv*, *Dmgr*, *Custom*, *AdminAgent*, *JobMgr* o *SecureProxySrv*.
...
Es probable que deba abrir puertos en el cortafuegos para permitir el acceso a aplicaciones y bases de datos.
  * En cada WebSphere Application Server del nodo de {{site.data.keyword.Bluemix_notm}}, encontrará un script openFirewallPorts.sh en el directorio WAS_HOME/virtual/bin.
...
WebSphere Application Server tradicional y Liberty se configuran con el protocolo [SSL_TLSv2](https://www.ibm.com/support/knowledgecenter/en/SSYKE2_8.0.0/com.ibm.java.security.component.80.doc/security-component/jsse2Docs/protocols.html){: new_window}.  Para cambiar el protocolo, modifique las siguientes líneas:

Para WebSphere Application Server tradicional:

1. Edite **security.xml** en /opt/IBM/WebSphere/Profiles/*profile_name*/config/cell/*cell_name* y modifique la línea siguiente:
...
2. Edite **ssl.client.props** en /opt/IBM/WebSphere/Profiles/*profile_name*/properties y modifique la línea siguiente:
...
1. Edite **server.xml** en /opt/IBM/WebSphere/Profiles/Liberty/servers/server1 y modifique la siguiente línea, situada en el elemento de configuración de ssl defaultSSLConfig:
